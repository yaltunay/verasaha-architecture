...
- **Uygulama:** Paket içermeyen CQRS (command/query handler’lar ve reader servisleri), DI ile kayıt; use case’ler domain ve kalıcılığı orkestre eder.
